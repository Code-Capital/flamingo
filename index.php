            ...
            <div class="row mx-0">
                <div class="col-lg-5 mx-auto px-0">
                    <div class="row mx-auto justify-content-center align-items-stretch">
                        <div class="col-8">
                            <input class="form-control form-control-lg h-100 newsLetterInput" type="text" placeholder="Your email">
                        </div>
                        <div class="col-4">
                            <button class="btn btn-primary px-4 h-100">Join Now</button>
                        </div>
                    </div>
                </div>
            </div>
