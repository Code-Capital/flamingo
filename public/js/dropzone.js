!(function () {
                    ...
                    if ("crop" === n)
                        a > o
                            ? ((r.srcHeight = e.height),
                              (r.srcWidth = r.srcHeight * o))
                            : ((r.srcWidth = e.width),
                              (r.srcHeight = r.srcWidth / o));
                    else {
                        if ("contain" !== n)
                            throw new Error(
                                "Unknown resizeMethod '".concat(n, "'")
                            );
                        a > o ? (i = t / a) : (t = i * a);
                    }
                return (
        ...
        f = (function (n) {
            ...
            function o(n, r) {
                ...
                if (
                    ...
                    (l.options.previewTemplate =
                        l.options.previewTemplate.replace(/\n*/g, "")),
                    ...
                    [
                                    ...
                                    var h = this,
                                        p = function () {
                                            ...
                                            h.hiddenFileInput &&
                                                ...
                                                (h.hiddenFileInput.style.visibility =
                                                    "hidden"),
                                                (h.hiddenFileInput.style.position =
                                                    "absolute"),
                                                (h.hiddenFileInput.style.top =
                                                    "0"),
                                                (h.hiddenFileInput.style.left =
                                                    "0"),
                                                (h.hiddenFileInput.style.height =
                                                    "0"),
                                                (h.hiddenFileInput.style.width =
                                                    "0"),
                                                o
                                                    .getElement(
                                                        h.options
                                ...
                                this._transformFiles(e, function (i) {
                                    ...
                                    if (e[0].upload.chunked) {
                                        ...
                                        var s = function () {
                                            for (
                                                var t = 0;
                                                void 0 !== l.upload.chunks[t];

                                            )
                                                t++;
                                            if (
                                                !(t >= l.upload.totalChunkCount)
                                            ) {
                                                0;
                                                var i = t * r.options.chunkSize,
                                                    a = Math.min(
                                                        i + r.options.chunkSize,
                                                        n.size
                                                    ),
                                                    s = {
                                                        name: r._getParamName(
                                                            0
                                                        ),
                                                        data: n.webkitSlice
                                                            ? n.webkitSlice(
                        ...
                        },
                        {
                            ...
                            value: function (t, i) {
                                ...
                                t[0].upload.chunked &&
                                    (t[0].upload.chunks[i[0].chunkIndex].xhr =
                                        l);
                                var f = this.resolveOption(
                                        this.options.method,
                                        t
                                    ),
                                ...
                                l.open(f, m, !0),
                                    ...
                                    ((null != l.upload
                                        ...
                                        return o._updateFilesUploadProgress(
                                            t,
                                            l,
                                            e
                                        );
                                ...
                                for (var y in (this.options.headers &&
                                    e(u)(v, this.options.headers),
                                v)) {
                                    var g = v[y];
                        ...
                        },
                        {
                            ...
                            value: function (e, t, i) {
                                ...
                                if (e[0].upload.chunked) {
                                    ...
                                    for (
                                        var l = 0;
                                        l < c.upload.totalChunkCount;
                                        l++
                                    )
                                        c.upload.chunks[l] &&
                                            void 0 !==
                                                c.upload.chunks[l].progress &&
                                            ((c.upload.progress +=
                                                c.upload.chunks[l].progress),
                                            (c.upload.total +=
                                                c.upload.chunks[l].total),
                                            (c.upload.bytesSent +=
                                                c.upload.chunks[l].bytesSent));
                                    (c.upload.progress =
                                        c.upload.progress /
                                        c.upload.totalChunkCount),
                                        this.emit(
                                            "uploadprogress",
                                            c,
                                            c.upload.progress,
    ...
    var y = function (e, t, i, n, r, a, o, l, s, u) {
            var c = (function (e) {
                ...
                n.drawImage(e, 0, 0);
                for (
                    var r = n.getImageData(1, 0, 1, t).data,
                        a = 0,
                        o = t,
                        l = t;
                    l > a;
