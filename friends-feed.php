...
<main>
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-4 pb-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center flex-grow-1 pt-4">
                            ...
                            <div class="d-flex gap-3 align-items-center">
                                ...
                                <a href="createEvent" class="btn btn-primary px-4">Follow</a>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu mt-2">
                                        <li><a data-bs-toggle="modal" data-bs-target="#report" class="dropdown-item">Report</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="report" tabindex="-1" aria-labelledby="reportLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header d-flex align-items-center justify-content-end border-0 m-0">
                    <div class="text-end">
                        <button type="button" class="btn-close mt-3 me-3" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                </div>
                <div class="modal-body pt-0 px-3 px-md-3 px-lg-5 pb-3 pb-md-3 pb-lg-5">
                    <div class="px-0 px-md-0 px-lg-5">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea placeholder="Type your message" class="form-control" rows="5"></textarea>
                        </div>

                        <a href="friends-feed" type="button" class="btn btn-primary mt-4 px-4 w-100">Send</a>
                    </div>
                </div>
            </div>
        </div>
